...
public class RichTextCueViewModel extends CueViewModel<RichTextCue> {
    ...
    public void displayPage(int index) {
        ...
        App.getShowManager().getPlayerView().getRichTextViewController().setRichTextPage(index);
    }
    ...
    public void buildAnimation() {
        ...
        timeline.getKeyFrames().add(new KeyFrame(Duration.ZERO, (evt) -> {
            ...
            App.getShowManager().getPlayerView().getRichTextViewController().setRichTextPages(pages);
            displayPage(0);
        }));
